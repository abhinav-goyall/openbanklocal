...
import com.infy.openbanklocal.web.rest.errors.BadRequestAlertException;
import com.infy.openbanklocal.web.rest.util.HeaderUtil;
...
public String ping() {
    ...
    private static final String ENTITY_NAME = "openbanklocalCustomer";
